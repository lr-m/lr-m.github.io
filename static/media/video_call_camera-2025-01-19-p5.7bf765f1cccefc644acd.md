...
At the time of the discovery of these bugs, I was still having to take the SD card out of the camera, flash the **iperf** binary I wanted to run as well as a **gdbserver-static** binary - safe to say I was getting very sick of this. So let's put that method to rest and work out how I can get the files on the device remotely and execute them. 
...
![im_in.png](/assets/images/icsee_cameras/p3/im_in.png)
...
![http_buffer_allocation.png](/assets/images/icsee_cameras/p5/http_buffer_allocation.png)
...
![nice.webp](/assets/images/icsee_cameras/p5/nice.webp)
...
![stack_layout.png](/assets/images/icsee_cameras/p5/stack_layout.png)
...
![fixup.png](/assets/images/icsee_cameras/p5/fixup.png)
...
![payload_meme.jpeg](/assets/images/icsee_cameras/p5/payload_meme.jpeg)

## Spawning a Thread

So right now, we are getting execution, and then immediately fixing up and returning to normal execution, which is no fun. Ideally, because of the watchdog issue, and to maintain normal functionality, it would be great if we could spawn a thread and run a payload there.
...
![flash.gif](/assets/images/icsee_cameras/p5/flash.gif)
...
![spi_functions.png](/assets/images/icsee_cameras/p5/spi_functions.png)
...
![buffer_init.png](/assets/images/icsee_cameras/p5/buffer_init.png)
...
![transbuffer_send_call.png](/assets/images/icsee_cameras/p5/transbuffer_send_call.png)

![screen_spi_write.png](/assets/images/icsee_cameras/p5/screen_spi_write.png)
...
![callback.png](/assets/images/icsee_cameras/p5/callback.png)
...
![rgb.gif](/assets/images/icsee_cameras/p5/rgb.gif)
...
![image_control.jpg](/assets/images/icsee_cameras/p5/image_control.jpg)
...
![button_press_detector.png](/assets/images/icsee_cameras/p5/button_press_detector.png)
...
![luminance_flag.png](/assets/images/icsee_cameras/p5/luminance_flag.png)
...
int _start(void) {
    ...
    // overwrite draw to screen callback in struct
...
![buttons.gif](/assets/images/icsee_cameras/p5/buttons.gif)
...
![pong.gif](/assets/images/icsee_cameras/p5/pong.gif)
...
![pong_meme.png](/assets/images/icsee_cameras/p5/pong_meme.png)