...
toc: true
toc_sticky: true
tagline: "We have a way to get control of execution pre-auth via a dodgy strcpy call in a UPnP handler. This blog will focus on utilising ROP to get the router to misbehave - while also learning MIPS' quirks."
...
![rop_gadgets.png](/assets/images/router/p3/rop_gadgets.png)
...
![rop_joke.png](/assets/images/router/p3/rop_joke.png)
...
![registers.png](/assets/images/router/p3/registers.png)
...
![sendto_meme.jpg](/assets/images/router/p3/sendto_meme.jpg)
...
![pwned.png](/assets/images/router/p3/pwned.png)
...
![im_in.png](/assets/images/router/p3/im_in.png)

All the PoC's for crashes, as well as ROP exploits are all in the [github for this project](https://github.com/lr-m/Chaneve-Router-Analysis).
