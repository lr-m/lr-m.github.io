...
![busybox.png](/assets/images/yi_iot_camera/p2/busybox.png)
...
![daemon_cmd_injection.png](/assets/images/yi_iot_camera/p2/daemon_cmd_injection.png)

## libcloudapi

And here is the demo of the *libcloudapi* command injection being exploited to get a reverse shell:

![libcloudapi_cmd_injection.png](/assets/images/yi_iot_camera/p2/libcloudapi_cmd_injection.png)
...
![libcloudapi_cmd_injection.png](/assets/images/yi_iot_camera/p2/nx.png)
...
![gef.png](/assets/images/yi_iot_camera/p2/gef.png)
...
![crash_gef.png](/assets/images/yi_iot_camera/p2/crash_gef.png)
...
![info_proc_mappings.png](/assets/images/yi_iot_camera/p2/info_proc_mappings.png)
...
![sys_config_struct.png](/assets/images/yi_iot_camera/p2/sys_config_struct.png)

We can see the struct in a fixed memory location here:

![pre_global_overflow.png](/assets/images/yi_iot_camera/p2/pre_global_overflow.png)

And we can see it being overflowed here:

![post_global_overflow.png](/assets/images/yi_iot_camera/p2/post_global_overflow.png)
...
![pointers_in_heap.png](/assets/images/yi_iot_camera/p2/pointers_in_heap.png)
...
![pointers_in_global.png](/assets/images/yi_iot_camera/p2/pointers_in_global.png)
...
![sys_user_config_struct.png](/assets/images/yi_iot_camera/p2/sys_user_config_struct.png)
...
![global_overflow_poc.png](/assets/images/yi_iot_camera/p2/global_overflow_poc.png)

And here is a demo of the exploit using the FTP leak for completeness:

![ftp_stack_overflow_poc.png](/assets/images/yi_iot_camera/p2/ftp_stack_overflow_poc.png)
