...
toc: true
toc_sticky: true
tagline: "Now that we can look at the code in Ghidra and send messages to the camera to poke the handlers in the binary, let's try and find a few bugs! Hopefully we can find enough to get remote code execution."
...
![cmd_injection.png](/assets/images/icsee_cameras/p3/cmd_injection.png)
...
![iperf_error.png](/assets/images/icsee_cameras/p3/iperf_error.png)

There are also some weak checks for injection characters, but they don't check for the *&* symbol so we can just use that.

![character_checks.png](/assets/images/icsee_cameras/p3/character_checks.png)
...
![vanish.gif](/assets/images/icsee_cameras/p3/vanish.gif)
...
![shell_output.png](/assets/images/icsee_cameras/p3/shell_output.png)
...
![get_packet_int_overflow.png](/assets/images/icsee_cameras/p3/get_packet_int_overflow.png)
...
![malloc_overflow.png](/assets/images/icsee_cameras/p3/malloc_overflow.png)

![maybe_memcpy_heap_overflow.png](/assets/images/icsee_cameras/p3/maybe_memcpy_heap_overflow.png)
...
![stupid_function.png](/assets/images/icsee_cameras/p3/stupid_function.png)

![inside_stupid_function.png](/assets/images/icsee_cameras/p3/inside_stupid_function.png)
...
## The World's Worst Directory Traversal
...
![allowed_dir_check.png](/assets/images/icsee_cameras/p3/allowed_dir_check.png)
...
![prevent_dir_traversal.png](/assets/images/icsee_cameras/p3/prevent_dir_traversal.png)
...
![the_end_is_near.png](/assets/images/icsee_cameras/p3/the_end_is_near.png)
...
It's impossible to go anywhere else without adding a **/** after the **..** so this is as useful as it is going to get!
...
![pwned.png](/assets/images/icsee_cameras/p3/pwned.png)

The only constraint with the write is that the file size must be < *0xc000* (or 49152 bytes).

![size_constraint.png](/assets/images/icsee_cameras/p3/size_constraint.png)
...
![integer_underflow.png](/assets/images/icsee_cameras/p3/integer_underflow.png)
...
It is a shame that the integer overflow/underflow issues aren't exploitable, but nothing wrong with a DoS (at least that's what I tell myself)!

![no_more_dos_plz.png](/assets/images/icsee_cameras/p3/no_more_dos_plz.jpeg)