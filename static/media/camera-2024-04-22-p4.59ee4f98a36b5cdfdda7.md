...
So now that we have an over-sized string in **g_hw_config**, we can use the **IOTYPE_USER_IPCAM_GET_DEVICE_PARAM_REQ** message to fetch the string and send it back to us. 
