...
toc: true
toc_sticky: true
tagline: "Let's take a look at the KuWfi C920 travel router. The overall goal of this project is to achieve pre-auth code execution over LAN."
...
![admin_panel.png](/assets/images/travel_routers/p1/router.png)
...
![admin_panel.png](/assets/images/travel_routers/p1/admin_panel.png)
...
![web_panel.png](/assets/images/travel_routers/p1/web_panel.png)
...
![sd_card_panel.png](/assets/images/travel_routers/p1/sd_card_panel.png)
...
![http_share_panel.png](/assets/images/travel_routers/p1/http_share_panel.png)
...
![http_share_pre_login.png](/assets/images/travel_routers/p1/http_share_pre_login.png)

## Packet Captures

To investigate further, let's examine the packets being exchanged between the router and the web interface:

![web_traffic.png](/assets/images/travel_routers/p1/web_traffic.png)
...
![get_cmd_process.png](/assets/images/travel_routers/p1/get_cmd_process.png)
...
![set_cmd_process.png](/assets/images/travel_routers/p1/set_cmd_process.png)
...
![cgi_bin_httpshare.png](/assets/images/travel_routers/p1/cgi_bin_httpshare.png)
...
![front.png](/assets/images/travel_routers/p1/front.png)

![no_metal_covers.png](/assets/images/travel_routers/p1/no_metal_covers.png)
...
![chip.jpg](/assets/images/travel_routers/p1/chip.jpg)
...
![binvis.png](/assets/images/travel_routers/p1/binvis.png)
...
![binvis.png](/assets/images/travel_routers/p1/extracted.png)
...
![binvis.png](/assets/images/travel_routers/p1/rootfs.png)

Is this what I think it is?

![binvis.png](/assets/images/travel_routers/p1/adb.png)
...
![binvis.png](/assets/images/travel_routers/p1/shell.png)
...
![binvis.png](/assets/images/travel_routers/p1/goform_init.png)

### ***/goform***

We'll start by looking at the ***/goform*** handler, as it seems that most of the functionality goes via this endpoint.

![binvis.png](/assets/images/travel_routers/p1/goform_handler.png)
...
![binvis.png](/assets/images/travel_routers/p1/qrcode_ssid_wifikey.png)
