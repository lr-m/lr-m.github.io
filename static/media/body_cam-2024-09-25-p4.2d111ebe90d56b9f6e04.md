...
![mem_read.png](/assets/images/action_camera/p4/turn_off_mpu.png)
...
![setup_memory.png](/assets/images/action_camera/p4/setup_memory.png)

We can see the **change_memory_attributes** function being called:

![change_memory_attributes.png](/assets/images/action_camera/p4/change_memory_attributes.png)
...
![attr_value.png](/assets/images/action_camera/p4/attr_value.png)
...
![midr.png](/assets/images/action_camera/p4/midr.png)
...
![cpu_midr.png](/assets/images/action_camera/p4/cpu_midr.png)

So the MIDR is 0x410fc075, putting together a quick python script to parse it yields the following output:

![midr_parse.png](/assets/images/action_camera/p4/midr_parse.png)

And with that we have all the info we need! The CPU is ...

![drumroll.gif](/assets/images/action_camera/p4/drumroll.gif)

An ARM Cortex-A7!

![cortex_a7_midr.png](/assets/images/action_camera/p4/cortex_a7_midr.png)
