...
toc: true
toc_sticky: true
tagline: "In the previous blog, we got our hands on some firmware, and extracted a large App file. In this blog, we will use this and the iCSee application plus captures to reverse the communication protocol for port 34567."
...
![encrypted_response.png](/assets/images/icsee_cameras/p2/encrypted_response.png)
...
![operator_comment.png](/assets/images/icsee_cameras/p2/operator_comment.png)
...
![1_function_call.png](/assets/images/icsee_cameras/p2/1_function_call.png)

2. The function will set **param_1** to be a pointer to a list of functions

![2_pointer_set.png](/assets/images/icsee_cameras/p2/2_pointer_set.png)

3. Give the third function in the list a catchy name as this is the function that does the handling

![handler_call.png](/assets/images/icsee_cameras/p2/handler_call.png)

![3_function_list.png](/assets/images/icsee_cameras/p2/3_function_list.png)
...
![encryption_snippet.png](/assets/images/icsee_cameras/p2/encryption_snippet.png)
...
![login_handler.png](/assets/images/icsee_cameras/p2/login_handler.png)
...
![login_parameters.png](/assets/images/icsee_cameras/p2/login_parameters.png)
...
![user_pass_in_app.jpg](/assets/images/icsee_cameras/p2/user_pass_in_app.jpg)

The username we extracted matches, but the password is different?

![confused_tom.png](/assets/images/icsee_cameras/p2/confused_tom.png)
...
![enc_dev_password.png](/assets/images/icsee_cameras/p2/enc_dev_password.png)

This function ends up calling **XMMD5Encrypt**:

![XMMD5Encrypt.png](/assets/images/icsee_cameras/p2/XMMD5Encrypt.png)
...
![mii_need_0_days.png](/assets/images/icsee_cameras/p2/mii_need_0_days.png)
