...
tags:
  ...
  - Reverse Engineering
  - Ghidra Scripting
tagline: "More and more open-source models are appearing thanks to a huge community of AI enthusiasts. Can these models be used for improving the efficiency of reverse engineers?"
---
...
![camera.png](/assets/images/other/llms_for_reverse_engineering/neuron_activation.gif)
...
![camera.png](/assets/images/other/llms_for_reverse_engineering/evolution.png)
...
![camera.png](/assets/images/other/llms_for_reverse_engineering/driving.gif)

And here is the brain of the best car:

![camera.png](/assets/images/other/llms_for_reverse_engineering/brain.gif)
...
![camera.png](/assets/images/other/llms_for_reverse_engineering/transformer.png)
...
![camera.png](/assets/images/other/llms_for_reverse_engineering/chatgpt.png)
...
![camera.png](/assets/images/other/llms_for_reverse_engineering/llama2.png)
...
The script is [on github](https://github.com/lr-m/GhidrOllama), feel free to have a look or download and use it!
...
I have been using this script in my day-to-day Ghidra-ing and honestly I've found it quite useful for offloading tedious tasks, or saving me a Google search. You can also bind it to the 'Q' key for very easy access. [Give it a try](https://github.com/lr-m/GhidrOllama), and let me know what you think!

![camera.png](/assets/images/other/llms_for_reverse_engineering/ghidrollama.png)