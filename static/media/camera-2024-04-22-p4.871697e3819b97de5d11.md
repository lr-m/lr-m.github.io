...
![offset.png](/assets/images/yi_iot_camera/p4/offset.png)
...
![set_led_time.png](/assets/images/yi_iot_camera/p4/set_led_time.png)
...
![set_ap_mode.png](/assets/images/yi_iot_camera/p4/set_ap_mode.png)

These extracted parameters are passed to the **yi_p2p_on_set_ap_conf** function:

![p2p_set_ap_conf.png](/assets/images/yi_iot_camera/p4/p2p_set_ap_conf.png)
...
![sys_wifi_config_struct.png](/assets/images/yi_iot_camera/p4/sys_wifi_config_struct.png)
...
![stack_overflow_1_exploit.png](/assets/images/yi_iot_camera/p4/stack_overflow_1_exploit.png)
...
![set_wifi_info.png](/assets/images/yi_iot_camera/p4/set_wifi_info.png)
...
![save_wifi_info2tmp.png](/assets/images/yi_iot_camera/p4/save_wifi_info2tmp.png)
...
![stack_overflow_2_exploit.png](/assets/images/yi_iot_camera/p4/stack_overflow_2_exploit.png)
...
![set_device_param_req.png](/assets/images/yi_iot_camera/p4/set_device_param_req.png)
...
![p2p_set_device_param_req.png](/assets/images/yi_iot_camera/p4/p2p_set_device_param_req.png)
...
![get_device_param_req.png](/assets/images/yi_iot_camera/p4/get_device_param_req.png)

![p2p_get_device_param_req.png](/assets/images/yi_iot_camera/p4/p2p_get_device_param_req.png)

We can see it calls **yi_p2p_reply_device_param_conf** with **g_hw_config** as the last parameter.

![p2p_device_param_reply.png](/assets/images/yi_iot_camera/p4/p2p_device_param_reply.png)
...
![global_to_stack_overflow_exploit.png](/assets/images/yi_iot_camera/p4/global_to_stack_overflow_exploit.png)
...
![update_hw.png](/assets/images/yi_iot_camera/p4/update_hw.png)
...
![update_hw_cmd_injection.png](/assets/images/yi_iot_camera/p4/update_hw_cmd_injection.png)
