...
![crosstools_menu.png](/assets/images/router/p5/crosstools_menu.png)
...
![crosstools_target_options.png](/assets/images/router/p5/crosstools_target_options.png)

In this submenu, we need to change the _Target Architecture_ to mips:

![crosstools_target_architecture.png](/assets/images/router/p5/crosstools_target_architecture.png)

This will give the menu some extra options:

![crosstools_mips_menu.png](/assets/images/router/p5/crosstools_mips_menu.png)

We need to make sure we set the _Endianness_ option to little endian:

![crosstools_endianness.png](/assets/images/router/p5/crosstools_endianness.png)

And finally, set the _Bitness_ to 32-bit:

![crosstools_bitness.png](/assets/images/router/p5/crosstools_bitness.png)
...
![15_minutes_later.jpg](/assets/images/router/p5/15_minutes_later.jpg)
...
I hope you enjoyed this blog, the [usual github repo](https://github.com/lr-m/Chaneve-Router-Analysis) has been updated with the files described earlier.
