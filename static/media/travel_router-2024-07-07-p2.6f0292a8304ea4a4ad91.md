---
published: true
title: "🌎 [1] It's Raining Bugs - Auth Bypass + RCE"
toc: true
toc_sticky: true
...
![qr_code_overwrite.jpg](/assets/images/travel_routers/p2/qr_code_overwrite.jpg)
...
![config_clear.png](/assets/images/travel_routers/p2/config_clear.png)
...
![set_cfg.png](/assets/images/travel_routers/p2/set_cfg.png)
...
![mac_stack_overflow.png](/assets/images/travel_routers/p2/mac_stack_overflow.png)
...
![mac_gdb.png](/assets/images/travel_routers/p2/mac_gdb.png)
...
![remove_white_site_handler.png](/assets/images/travel_routers/p2/remove_white_site_handler.png)
...
![zte_mainctrl_rm_whitelist_handle.png](/assets/images/travel_routers/p2/zte_mainctrl_rm_whitelist_handle.png)

This is just calling into a subhandler, with the received data (after stripping off some *0x14* byte header):

![zte_mainctrl_overflow.png](/assets/images/travel_routers/p2/zte_mainctrl_overflow.png)

Huh, *0xffff* bytes going into a 100 byte buffer with an ***sprintf()*** call? Looks like a stack overflow to me!

![zte_mainctrl_crash.png](/assets/images/travel_routers/p2/zte_mainctrl_crash.png)
...
![sms_msg_id_overflow.png](/assets/images/travel_routers/p2/sms_msg_id_overflow.png)

Here is the code snippet that is causing the crash, it is crashing when it tries to write a 0 outside of the stack region:

![zte_parse_semicolon_snippet.png](/assets/images/travel_routers/p2/zte_parse_semicolon_snippet.png)
...
![qr_code_fetch.png](/assets/images/travel_routers/p2/qr_code_fetch.png)
