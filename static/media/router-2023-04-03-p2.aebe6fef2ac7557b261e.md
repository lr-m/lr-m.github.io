...
toc: true
toc_sticky: true
tagline: "In the last blog, we found a bunch of interesting stuff. Using the UART, we also extracted the firmware and loaded it into Ghidra. The next goal is code execution - but we are going to need to find some bugs to get there."
...
![buffer-overflow-illustration.png](/assets/images/router/p2/buffer-overflow-illustration.png)
...
![buffer_overflow_attack.png](/assets/images/router/p2/buffer_overflow_attack.png)
...
![leafblowerformat.png](/assets/images/router/p2/leafblowerformat.png)

![leafblowerstring.png](/assets/images/router/p2/leafblowerstring.png)
...
![config_get_str.png](/assets/images/router/p2/config_get_str.png)
...
![config_meme.jpg](/assets/images/router/p2/config_meme.jpg)
...
![uboot.png](/assets/images/router/p2/uboot.png)
...
![broken_cfg.png](/assets/images/router/p2/broken_cfg.png)
...
![upnp_bugs.png](/assets/images/router/p2/upnp_bugs.png)
