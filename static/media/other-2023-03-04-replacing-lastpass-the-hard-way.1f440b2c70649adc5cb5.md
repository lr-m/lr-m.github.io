...
tags:
  ...
  - C++
  - Python
tagline: "There are plenty of great ways to store your passwords in a secure fashion. This blog will detail a device I created to try and create a secure local vault for my passwords!"
---
...
![to_base64.png](/assets/images/other/replacing_lastpass_the_hard_way/to_base64.png)

And here is the decoding result:

![from_base64.png](/assets/images/other/replacing_lastpass_the_hard_way/from_base64.png)
...
![wannacry.png](/assets/images/other/replacing_lastpass_the_hard_way/wannacry.png)
...
![hashing.png](/assets/images/other/replacing_lastpass_the_hard_way/hashing.png)
...
- **_IR Reciever and Remote_** : This will provide the interaction for the device, I'm familiar with this as I've used it for my previous [ESP8266 project](https://lr-m.github.io/coding/a-hands-on-guide-to-building-a-crypto-ticker/).
...
![layout.png](/assets/images/other/replacing_lastpass_the_hard_way/layout.png)
...
![drift_meme.jpg](/assets/images/other/replacing_lastpass_the_hard_way/drift_meme.jpg)
...
![master.jpg](/assets/images/other/replacing_lastpass_the_hard_way/master.jpg)
...
![home.jpg](/assets/images/other/replacing_lastpass_the_hard_way/home.jpg)
...
![pwd.png](/assets/images/other/replacing_lastpass_the_hard_way/pwd.png)
...
![wallet.png](/assets/images/other/replacing_lastpass_the_hard_way/wallet.png)
...
![ecb_penguin.png](/assets/images/other/replacing_lastpass_the_hard_way/ecb_penguin.png)
...
![ecb_meme.jpg](/assets/images/other/replacing_lastpass_the_hard_way/ecb_meme.jpg)
...
![block1.jpg](/assets/images/other/replacing_lastpass_the_hard_way/block1.png)
...
![block2.jpg](/assets/images/other/replacing_lastpass_the_hard_way/block2.png)
...
![init.png](/assets/images/other/replacing_lastpass_the_hard_way/init.png)
...
![figlet.png](/assets/images/other/replacing_lastpass_the_hard_way/figlet.png)
...
![help.png](/assets/images/other/replacing_lastpass_the_hard_way/help.png)
...
This was a pretty fun project, it allowed me to prove to myself that I understand basic cryptography, and I can incorporate it into a simple client-server infrastructure. If you want to check out all of the code, it is [on my github](https://github.com/lr-m/Vault), feel free to take it and improve (or fix) it.
...
![logo.png](/assets/images/other/replacing_lastpass_the_hard_way/logo.png)
