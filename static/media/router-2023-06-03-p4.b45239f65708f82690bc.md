---
published: true
title : "📡 [3] Process Continuation + Shellcode"
toc: true
toc_sticky: true
...
![this_is_fine_meme.jpg](/assets/images/router/p4/this_is_fine_meme.jpg)
...
![3_bytes_expected.png](/assets/images/router/p4/3_bytes_expected.png)
...
![3_bytes_7_bits_expected.png](/assets/images/router/p4/3_bytes_7_bits_expected.png)
...
![m_search_overflow_caller.png](/assets/images/router/p4/m_search_overflow_caller.png)
...
![why_work.jpg](/assets/images/router/p4/why_work.jpg)
...
![write_test.png](/assets/images/router/p4/write_test.png)
...
![shellcode.jpg](/assets/images/router/p4/shellcode.jpg)
...
![caches.png](/assets/images/router/p4/caches.png)
...
![flush.jpg](/assets/images/router/p4/flush.jpg)
...
![printf.png](/assets/images/router/p4/printf.png)
...
![packets.png](/assets/images/router/p4/packets.png)

And here are the contents of the UDP packet containing the password:

![packet_contents.png](/assets/images/router/p4/packet_contents.png)

We can see the password is *th35he11c0d3w0rk5*!

![anonymous_cat.jpg](/assets/images/router/p4/anonymous_cat.jpg)
...
Thanks for reading, the [repo for this project](https://github.com/lr-m/Chaneve-Router-Analysis) contains everything discussed in all blogs in this series - feel free to check it out!
